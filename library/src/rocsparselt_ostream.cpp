...
// Predeclare rocsparselt_abort_once() for friend declaration in rocsparselt_ostream.hpp
static void rocsparselt_abort_once [[noreturn]] ();
...
/***********************************************************************
 * rocsparselt_internal_ostream functions                                           *
 ***********************************************************************/

// Abort function which is called only once by rocsparselt_abort
static void rocsparselt_abort_once()
{
#ifndef WIN32
    ...
    rocsparselt_internal_ostream::clear_workers();
...
{
    // If multiple threads call rocsparselt_abort(), the first one wins
    static int once = (rocsparselt_abort_once(), 0);
}

// Get worker for writing to a file descriptor
std::shared_ptr<rocsparselt_internal_ostream::worker>
    rocsparselt_internal_ostream::get_worker(int fd)
{
    ...
    // Lock the map from file_id -> std::shared_ptr<rocsparselt_internal_ostream::worker>
    ...
    // worker_ptr is a reference to the std::shared_ptr<rocsparselt_internal_ostream::worker>
...
// Construct rocsparselt_internal_ostream from a file descriptor
rocsparselt_internal_ostream::rocsparselt_internal_ostream(int fd)
...
// Construct rocsparselt_internal_ostream from a filename opened for writing with truncation
rocsparselt_internal_ostream::rocsparselt_internal_ostream(const char* filename)
{
...
rocsparselt_internal_ostream::~rocsparselt_internal_ostream()
{
    flush(); // Flush any pending IO
}

// Flush the output
void rocsparselt_internal_ostream::flush()
{
...
void rocsparselt_internal_ostream::clear_workers()
{
    std::lock_guard<std::recursive_mutex> lock(worker_map_mutex());
    worker_map().clear();
}
...
std::ostream& rocsparselt_internal_ostream::yaml_on(std::ostream& os)
{
    return os;
}

std::ostream& rocsparselt_internal_ostream::yaml_off(std::ostream& os)
{
    return os;
}

/***********************************************************************
 * rocsparselt_internal_ostream::worker functions handle logging in a single thread *
 ***********************************************************************/

// Send a string to the worker thread for this stream's device/inode
// Empty strings tell the worker thread to exit
void rocsparselt_internal_ostream::worker::send(std::string str)
{
...
void rocsparselt_internal_ostream::worker::thread_function()
{
...
rocsparselt_internal_ostream::worker::worker(int fd)
{
...
rocsparselt_internal_ostream::worker::~worker()
{
